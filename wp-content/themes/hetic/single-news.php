<?php get_header(); //appel du template header.php  ?>
    <main class="main article">
        ...
        <ul class="article-share">
            <li class="facebook">
                <a href="#" title="facebook share" target="_blank">
            ...
            <li class="twitter">
                <a href="#" title="twitter share" target="_blank">
                    <svg viewBox="0 0 24 24">
                        <path fill="#000000"
            ...
            <li class="linkedin">
                <a href="#" title="linkedin share" target="_blank">
                    <svg viewBox="0 0 24 24">
                        <path fill="#000000"
            ...
            <ul>
				...
				if ( $lastposts ) { ?>
					...
					foreach ( $lastposts as $post ) :
						setup_postdata( $post ); ?>
                        <li><a href="<?php the_permalink() ?>" title="article name"><?php the_title(); ?></a></li>
						<?php
					endforeach;
					wp_reset_postdata();
					?>
